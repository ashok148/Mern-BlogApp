...
const Login = () => {
    ...
    return (
        <Grid container display="flex" height="100vh" >
            <Grid item xs={0} sm={7}>
                <img className="backImage" src="https://media.istockphoto.com/photos/road-picture-id1318075689?b=1&k=20&m=1318075689&s=170667a&w=0&h=s4BPeCGRMdrZOsb6zMrO6DMhvZAi9SJoS-rzWorwvwQ=" width="100%" height="100%" />
            </Grid>
